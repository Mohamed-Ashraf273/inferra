"""Script to generate inferra public API in `inferra/api` directory.
...
def copy_source_to_build_directory(root_path):
    # Copy sources (`inferra/` directory and setup files) to build dir
...
def build():
    ...
    try:
        ...
        # Copy back the inferra/api from build directory
